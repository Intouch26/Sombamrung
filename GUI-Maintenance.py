...
######TAB2#######
header = ['TSID','ชื่อ','แผนก','อุปกรณ์','ปัญหา','หมายเลข','เบอร์โทร']
...
#ปรับขนาด font และตารางให้ใหญ่ขึ้น
style = ttk.Style()
style.configure('Treeview.Heading',font=('Angsana New',20,'bold'))
style.configure('Treeview',rowheight=30,font=('Angsana New',20,))
...
def Delete_mtworkorder(event=None):
    ...
    check = messagebox.askyesno('ยืนยันการลบ','คณต้องการลบข้อมูลใช่หรือไม่?')
    print(check)
